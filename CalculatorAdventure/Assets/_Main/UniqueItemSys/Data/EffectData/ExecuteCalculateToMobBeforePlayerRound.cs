...
{
    //12001 ~ 12004
    [CreateAssetMenu(fileName = "ExecuteCalculateBeforePlayerRound", menuName = "SoSetting/UniqueItem/UniqueItemData", order = 0)]
    public class ExecuteCalculateToMobBeforePlayerRound : UniqueItemData
    {
