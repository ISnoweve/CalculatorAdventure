...
{
    [CreateAssetMenu(fileName = "LeaveCalculatorButtons_NotPrime",
        menuName = "SoSetting/Mob/Skills/LeaveCalculatorButtons_NotPrime", order = 3)]
    public class AtkS_LeaveCalculatorButtons_NotPrime : AttackSkillData
    {
        public override void Execute()
        {
            ...
            HealthSystem.Instance.ModifyPlayerHealthByMobAttack(calculatorButtonsIsPrime);
            ButtonSystem.CloseNumberButtonClickableByAttackSkill(calculatorButtonsIsPrime);
        }
