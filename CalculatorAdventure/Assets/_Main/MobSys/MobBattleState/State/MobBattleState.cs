...
namespace _Main.MobSys.MobBattleState.State
{
    [Serializable]
    public class MobBattleState : Singleton<MobBattleState>
    {
        ...
        private void SubscribeEvent()
        {
            ...
            GlobalMessagePipe.GetSubscriber<FinishedUpdateBehaviourCountDown>().Subscribe(StateEnter_PlayerTurn).AddTo(bag);
        ...
        {
            NotifyMobBattleNewState newState = new NotifyMobBattleNewState(mobBattleStateEnum);
